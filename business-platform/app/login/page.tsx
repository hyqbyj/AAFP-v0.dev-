      ...
      <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div className="flex flex-col items-center">
            ...
            <h2 className="mt-2 text-2xl font-bold leading-9 tracking-tight text-gray-900">登录您的账户</h2>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="bg-white px-2 text-muted-foreground">或通过以下方式登录</span>
                </div>
              </div>
        ...
        <div className="absolute inset-0 h-full w-full bg-gradient-to-r from-purple-400 to-purple-600">
          <div className="flex h-full items-center justify-center">
            <div className="text-center text-white">
              ...
              <p className="mt-2 text-lg">登录您的账户，继续使用AAFB平台</p>
            </div>
          </div>
        </div>
      </div>
